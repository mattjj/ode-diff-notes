...
\end{equation}
On the vector space of solutions $\mathcal{Y}$ consider a nice linear
functional $\mathcal{D}: \mathcal{Y} \to \mathbb{R}$. This induces a linear
function on the vector space of possible perturbations $v$.

Take the special case of the evaluation functional $\mathcal{D}[y] =
d^\mathsf{T} y(1)$.
% We have
% \begin{align}
%     d^\mathsf{T} y(1)
%     &= d^\mathsf{T} \left( C v + \int_{0}^1 A(t) z(t) + B(t) v \, \mathrm{d} t \right) \\
%     &= 
% \end{align}
